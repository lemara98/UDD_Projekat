...
public interface CVRepository extends ElasticsearchRepository<CV, String> {
	...
	@Query("{\"bool\":{\"must\":{\"match_all\":{}},\"filter\":{\"geo_distance\":{\"distance\":\"?2km\",\"geoPoint\":{\"lat\":?0,\"lon\":?1}}}}}\r\n")
	SearchHitsImpl<CV> findCVByGeoLocation(Double lat, Double lon, Integer rad);
}
